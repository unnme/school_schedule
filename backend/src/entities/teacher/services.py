...
from src.api.depends.repository import teacher_repository
from src.entities.teacher.schemas import (
...
from src.entities.teacher.validators import validate_teacher_request
