...
class StudentGroupManager:
    ...
    async def create_student_group(
        ...
        student_group = await student_group_repository.create_student_group(session, request_data)
    ...
    async def update_sutdent_group(
        ...
        async with session.begin():
            student_group = await student_group_repository.update_sutdent_group(session, request_data, student_group_id)
    ...
    async def delete_sutdent_group(
        ...
        student_group = await student_group_repository.delete_sutdent_group(session, student_group_id)
